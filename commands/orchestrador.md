...
Quando invocado, leia `${CLAUDE_PLUGIN_ROOT}/commands/orchestrator.md` e execute exatamente o mesmo workflow ali definido, preservando todos os argumentos fornecidos pelo usuario em `$ARGUMENTS`.
